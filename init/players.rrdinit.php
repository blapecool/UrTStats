<?php
/*
    UrTStats - ~/crons/players.rrdinit.php
    ...
    Create and init rrd file for players stats ;)
*/

$rrdFile = dirname(__FILE__) . "/../data/players.rrd";

if(!file_exists($rrdFile))
{
    $creator = new RRDCreator($rrdFile, "now -1d", 300);
    $creator->addDataSource("players:GAUGE:600:0:U");
    $creator->addDataSource("playersPV:GAUGE:600:0:U");
